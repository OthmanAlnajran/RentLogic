...
if ($property) {
    ...
    echo '<p style="margin: 5px 0; font-size: 1rem; color: #555;"><strong>Description:</strong> ' . 
        (!empty($property['description']) ? htmlspecialchars($property['description']) : 'No description available.') . 
        '</p>';

    // Schedule Visit Section
    echo '<div style="margin-top: 20px;">';
    echo '<h3 style="font-size: 1.2rem; color: #0073e6;">Schedule a Visit</h3>';
    ...
    echo '<label for="visit_time" style="font-size: 1rem; color: #555;">Choose a Time:</label>';
